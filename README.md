...
從上圖可以看出，在 <img src="https://latex.codecogs.com/svg.image?\inline&space;\tau&space;>&space;1" title="https://latex.codecogs.com/svg.image?\inline \tau > 1" />$\tau > 1$ 的時候，bpp 會下降，PSNR 則會上升；反之，在 $\tau < 1$ 的時候，bpp 會上升，PSNR 則會下降。
